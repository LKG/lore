...
public class IndexController extends AbstractController {
	...
	public void articlesTop10(HttpServletRequest request,ModelMap model){
		...
		PageRequest pageRequest= DynamicPageRequest.buildPageRequest(1,10, "pushTime",CommonConst.Page.DEFAULT_ORDER,Article.class);
	...
	public void docsTop10(HttpServletRequest request,ModelMap model){
		...
		PageRequest pageRequest= DynamicPageRequest.buildPageRequest(1,10, "pushTime",CommonConst.Page.DEFAULT_ORDER,Periodical.class);

...
<div class="list-group text-center user-menu" style="min-height: 368px;">
    ...
    <a href="${contextPath}/userinfo/orders.jhtml" class="list-group-item <#if template=='orders'>active</#if>" >
    ...
    <!--
     ...
     <a href="${contextPath}/userinfo/levels.jhtml" class="list-group-item <#if template=='level'>active</#if>">
		...
		-->
	 <a href="${contextPath}/userinfo/follows.jhtml" class="list-group-item <#if template=='follows'>active</#if>"">

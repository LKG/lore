<header id="header">
    <div class="header-box">
        ...
        <ul class="header-right">
            <@shiro.guest>
            <li class="denglu"> <a href="${contextPath}/login.jhtml">您好，请登录</a>
                <a id="J_RegisterLink1" class="red" href="${contextPath}/regist.jhtml" target="_blank" tabindex="8"><@spring.message  code="label.register.button" /></a>
            </li>
            </@shiro.guest>
           ...
           <li class="shu"></li>
            <@shiro.hasRole name="admin" >
				<li class="sn-sitemap">
                    <a class="header-logo-invertocat" href="${contextPath}/admin.jhtml" >
                        管理后台
                    </a>
                </li>
             <li class="shu"></li>
            ...
            <li class="my bj">
                ...
                <div class="my1">
                    <div class="my2">
                        ...
                        <div class="my3">
                            <@shiro.guest>  <h3 class="neirong2"><a href="${contextPath}/login.jhtml">您好，请登录</a></h3>  </@shiro.guest>
                            <p class="neirong2"><a href="">优惠卷 丨 消息</a></p>
                        </div>
                    </div>
                    <ul class="neirong2">
                        <li><a href="${contextPath}/userinfo/orders.jhtml">带处理订单</a></li>
                        <li><a href="${contextPath}/userinfo/orders.jhtml">我的订单</a></li>
                    </ul>
                </div>
            </li>
            <li class="shu"></li>
            <li class="guanzhu bj">
                ...
                <div class="guanzhu1"><img style="width: 140px;" src="${contextPath}/images/qq_vip.jpg"></div>
            </li>
            <li class="shu"></li>
            <li class="kehu bj">
                <a href="#">客户服务</a>
